<template>
	<view class="gray_bg">
		...
		<!--测试报告头部-->
		<view class="report_head" v-if="detailData">
			<view class="report_top">
				...
				<view class="report_progress">
					...
					<view class="progress_data">
						...
						<view class="h3">Lv.{{detailData.level}}</view>
			...
			<div class="report_data" v-if="reportData">
				...
				<view class="report_list">
					<view class="li act" v-for="item in reportData.content">
		...
		>
			<view class="h3">{{langData.shareReport.reportAdTitle[lan]}}</view>
			<view class="p">{{langData.shareReport.reportAdDes[lan]}}</view>
		</view>
