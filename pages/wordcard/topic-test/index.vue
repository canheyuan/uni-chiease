  ...
  <view class="topic-page" >
		...
		<uni-popup ref="outPopup" type="center">
			<div class="close-page-tip-pop">
				...
				<h3 class="title" @click="afterSuccessFn">{{langData.wordTopic.outTitle[lan]}}</h3>
...
export default {
	...
	methods:{
		//测试用
		testAudioFn(){
			console.log('播放testAudioFn')
			this.testPlayAudio()
		},
		
		testPlayAudio(){
			//audioObj.src = 'https://test.5ideachinese.com/profile/frontend/static/audio/jc_audio01.mp3'
			audioObj.src = 'http://audio04.dmhmusic.com/71_53_T10038854296_128_4_1_0_sdk-cpm/cn/0311/M00/26/0E/ChAKC113ay2AHm4yAERpsbwBlh0983.mp3?xcode=cf1cc8d3576177db6241aaa0d3566c04e7bc0b5'
			audioObj.play()
		},
		...
		answerResult(){
			...
			if( _this.subjectIndex == _this.subjectDatas.totalSubjectNum-1){
				...
				if(masterLexiconNum < totalLexiconNum){
					...
					uni.navigateTo({ url : '/pages/wordcard/result/index'})
				}
