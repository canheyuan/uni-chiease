<template>
    <view class="topic-result" v-if="wordParentData">
        ...
        <view class="p">
			{{langData.topicResult.desText1[lan] + 
			wordParentData.nameMulti[lan] + 
			langData.topicResult.desText2[lan] + 
			wordParentData.subitem + 
			langData.topicResult.desText3[lan]}}
		</view>
        ...
        <view 
			v-if="source=='h5'" @click="downlaodPopFn" class="share-btn"
		>{{langData.topicResult.downLoadBtn[lan]}}</view>
